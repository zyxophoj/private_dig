...
func main() {
	// Evil hard-coded data!
	// TODO: this is almost certainly rippable, so rip it.
	...
	// Looking for the form by name is a surprisingly bad idea since there are duplicates.
